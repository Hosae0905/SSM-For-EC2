...
public class EventAccessException extends BusinessException {
    ...
    public static EventAccessException formemberEmail(String memberEmail) {
        return new EventAccessException(ErrorCode.UNAUTHORIZED_ACCESS_EVENT, String.format("%s님은 일정에 접근 권한이 없습니다.", memberEmail));
    }
